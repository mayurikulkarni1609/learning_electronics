...
I was thinking about resistors, specifically
metal oxide/metal film ones.
They have that cylindrical body, and I remembered that the
resistance value is set by cutting a spiral path in the
resistive film.
...
That immediately broke the clean mental
seperation of:
- resistor = R
- inductor = L
...
Once I accepted inductance, another question 
popped up:

If there are adjacent spiral turns separated by
insulation,
...
That distinction feels important and slightly
annoying that it's not stated clearly in courses.

---

## Current understanding (still evolving)
- Every object is a model, not a perfect
object
- Components are named by what dominates in a
given frequency range
- Saying "inductor with resistance" or "resistor
with inductance" is a modelling choice

This is obvious in hindsight.
It was not obvious when I first learned R, L,
and C separately.
...
Not the final explanation, but the confusion
that led to it.

future me:
If a circuit behaves weirdly at high frequency,
remember this page before blaming the power
supply.
